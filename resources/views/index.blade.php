		...
		<section class="section featured-venues">
			<div class="container">
										...
										<div class="listing-content">
											...
											<div class="listing-details-group">
												...
												<ul>
													...
													<li>
														{{-- <span>
															<i class="feather-calendar"></i>Giờ mở cửa: <span class="primary-text">{{ $thongtin['gioMoCua'] }}</span>
														</span> --}}
													</li>
												</ul>
											</div>
				...
				<div class="view-all text-center aos" data-aos="fade-up">
					<a href="{{ route('danh_sach_san') }}" class="btn btn-secondary d-inline-flex align-items-center mt-10">Xem tất cả<span class="lh-1"><i class="feather-arrow-right-circle ms-2"></i></span></a>
				</div>
				<!-- View More -->
