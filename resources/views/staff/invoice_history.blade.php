...
@section('staff_content')
    <h1 class="h3 mb-4">Lịch Sử Đặt Sân</h1>

    <div class="card shadow-sm"  style="clear:both;">
        <form method="POST" action="{{ route("staff.history.search") }}">
        @csrf
            <div>
        ...
        <div class="card-header"><h5 class="mb-0">Lịch sử hóa đơn</h5></div>
            <div class="card-body">
